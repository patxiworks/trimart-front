  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        'bermuda': '#78dcca',
        'primary': {
          'deeper': colors['yellow']['800'],
          'deep': colors['yellow']['700'],
          'light-deep': colors['yellow']['500'],
          'logo': colors['orange']['400'],
          'normal': colors['orange']['200'],
          'light-normal': colors['orange']['100'],
