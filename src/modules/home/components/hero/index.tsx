...
import { text2xlSemi, textBaseRegular, textBaseSemi } from '@modules/design/custom-classes'
  ...
  return (
    <div className="h-[70vh] relative w-full">
      <Image
        ...
        fill={true}
      />
      <div className="small:justify-start small:items-center medium:p-32 small:absolute small:inset-0 z-10 flex flex-col items-center justify-center text-center p-0 small:mt-0">
        <div className="ios:p-2 bg-black opacity-80 p-6 pl-4 text-center">
          ...
          <div className={`${textBaseRegular} small:text-center mb-6 max-w-[32rem] text-white shadow-black drop-shadow-md`}>
